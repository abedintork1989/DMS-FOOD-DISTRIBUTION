...
const columns: Array<{ key: FilterKey; label: string; defaultWidth: number }> = [
  ...
  { key: "retention", label: "حاشیه سود هر مشتری", defaultWidth: 150 },
  { key: "churn", label: "حاشیه سود هر محصول", defaultWidth: 150 },
  { key: "activeCustomers", label: "سود هر ویزیتور", defaultWidth: 150 },
  { key: "targetCoverage", label: "پوشش مشتریان هدف", defaultWidth: 150 },
  { key: "repeatPurchase", label: "نرخ تکرار خرید", defaultWidth: 150 },
  { key: "fullOrderSupply", label: "درصد تأمین کامل سفارش", defaultWidth: 165 },
...
export default function ProfitSalesReportPage() {
  ...
  return (
    <AppShell>
      <PageHeader
        title="گزارش سود فروش"
        subtitle="بررسی شاخص‌های سود فروش به تفکیک "
      />
