...
const columns: Array<{ key: FilterKey; label: string; defaultWidth: number }> = [
  ...
  { key: "retention", label: "درصد وصول مطالبات", defaultWidth: 150 },
  { key: "churn", label: "مطالبات سررسیدگذشته", defaultWidth: 150 },
  { key: "activeCustomers", label: "میانگین زمان وصول پول", defaultWidth: 150 },
  { key: "targetCoverage", label: "مانده حساب مشتریان", defaultWidth: 150 },
  { key: "repeatPurchase", label: "نسبت فروش نقدی به اعتباری", defaultWidth: 150 },
...
export default function CashFlowReportPage() {
  ...
  return (
    <AppShell>
      <PageHeader
        title="گزارش نقدینگی"
        subtitle="بررسی شاخص‌های نقدینگی به تفکیک "
      />
